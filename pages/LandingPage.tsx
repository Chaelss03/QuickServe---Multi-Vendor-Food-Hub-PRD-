    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300 flex flex-col">
      <nav className="p-6 flex justify-between items-center max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-orange-500 rounded-xl flex items-center justify-center text-white font-black text-xl shadow-lg shadow-orange-200 dark:shadow-none">S</div>
          <span className="text-2xl font-black tracking-tighter dark:text-white">ServeFlow</span>
        </div>
              ...
              <div className="w-full relative">
                <div className="relative aspect-square w-full rounded-2xl overflow-hidden bg-black shadow-inner border-4 border-orange-500">
                  ...
                  <div className="absolute inset-0 border-2 border-orange-500/20 pointer-events-none">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border-2 border-orange-50 rounded-2xl flex items-center justify-center">
